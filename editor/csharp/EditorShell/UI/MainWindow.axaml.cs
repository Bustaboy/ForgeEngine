...
/// <summary>
/// Main editor shell. Related partials: <c>MainWindow.Dialogs.cs</c> (modals and settings window),
/// <c>MainWindow.Lifecycle.cs</c> (open/close, theme, shortcuts). This file keeps docking, viewport, and ribbon handlers.
/// </summary>
public partial class MainWindow : Window
{
    ...
    private StartupOnboardingOverlay? _startupOnboardingOverlay;
    ...
    private void InitializeComponent()
    {
        ...
        _startupOnboardingOverlay = this.FindControl<StartupOnboardingOverlay>("StartupOnboardingOverlay");
    ...
    private async void OnOpenSceneClick(object? sender, RoutedEventArgs e)
    {
        ...
        var files = await StorageProvider.OpenFilePickerAsync(new FilePickerOpenOptions
        {
            ...
            FileTypeFilter =
            [
                new FilePickerFileType("Soul Loom Scene")
                {
