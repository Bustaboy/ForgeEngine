...
cp "$PUBLISH_DIR/Soul.Editor" "$APP_BUNDLE/Contents/MacOS/Soul.Editor"
cp "$RUNTIME_BIN" "$APP_BUNDLE/Contents/MacOS/soul_runtime"
...
<key>CFBundleExecutable</key><string>Soul.Editor</string>
