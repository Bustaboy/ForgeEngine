# Archived release smoke evidence (tracked)

Local capture runs write to `docs/release/evidence/runs/` (gitignored). **Promoted** runs are copied here for RC traceability.
